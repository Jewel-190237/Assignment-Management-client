            ...
            <div>
                <div>
                    ...
                    <p className="text-center mx-auto md:w-3/4 mb-10">
                        <p>Assignment Insights: Unlocking the Path to Academic Excellence. Delve into the intricacies of each task, from deadlines to resources, grading criteria, and more. Illuminate your academic path with clarity and precision through comprehensive assignment details. </p>
                    </p>
                </div>
                <div className="hero ">
                ...
                <button onClick={() => handleDelete(_id)} className="btn btn-outline btn-block my-2 bg-emerald-300 ">
